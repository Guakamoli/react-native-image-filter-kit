...
export const shapes = {
    ...
    IosIFKTextImage: Object.assign({ inputText: text, inputLineWidth: scalar, inputFontName: text, inputFontSize: distance, inputColor: color, inputBackgroundColor: color, inputTextAlign: text }, Generator),
