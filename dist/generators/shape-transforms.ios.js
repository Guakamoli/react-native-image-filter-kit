...
export const shapeTransforms = {
    ...
    TextImage: (_a) => {
        var { color, text, fontSize, fontName, image, backgroundColor, textAlign } = _a, config = __rest(_a, ["color", "text", "fontSize", "fontName", "image", "backgroundColor", "textAlign"]);
        return (Object.assign(Object.assign({}, config), { name: 'IosIFKTextImage', inputImage: image, inputText: text, inputFontName: fontName, inputFontSize: fontSize, inputColor: color, inputBackgroundColor: backgroundColor, inputTextAlign: textAlign }));
    },
    CircleShape: (_a) => {
